      ...
      <nav className="max-w-7xl mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-2xl font-display font-semibold vara-gradient-text">Vara</span>
          </Link>
          ...
          <div className="flex items-center gap-8">
            ...
            <Link href="/about" className="text-vara-warmGray hover:text-vara-marigold transition-colors font-medium">
              About
            </Link>
